...
public class SignUpActivity extends AppCompatActivity {
    ...
    private FirebaseAuth auth;  // use of auth is email or passoword ko lekr sign Up ke liye
    FirebaseDatabase database;  // use of database is user se vakue lekr firebase me store krne ke liye
